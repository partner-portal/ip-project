...
/* See its GCC counterpart to know what needs to be defined here */
 ...
 *
 * We need to include stdatomic before setting __always_inline
 * Else it overrides us. Also, we need (fixme?) to include inttypes before
 *  stdatomic.
 */
#include <inttypes.h>
#include <stdatomic.h>
 ...
 * We do not want to force having a prototype in such cases.
 */
