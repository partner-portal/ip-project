...
#ifndef _LIBPNC_ARCH_ARMV8_SYSCALL_LOW_H_INCLUDED_
#define _LIBPNC_ARCH_ARMV8_SYSCALL_LOW_H_INCLUDED_
...
int arch_pnc_fast_kernel_call_iX+1_oY+1 (int kcall, const pnc_kcall_args_t *regs)
{
    ...
    register uint64_t ipc_type  asm ("x0")    = ipc_type_tmp;
    register uint64_t kcall_nr  asm ("x1")    = kcall_nr_tmp;
    register uint64_t arg_0     asm ("x2")    = arg_0_tmp;
    ...
    register uint64_t arg_X     asm ("xX+2")  = arg_X_tmp;

    register int64_t ret_code   asm ("x0");
    register uint64_t ret_0     asm ("x1");
    ...
    register uint64_t ret_Y     asm ("xY+1");
...
#define __FKCALL_ITER_IN_1(X)  __FKCALL_ITER_IN_0(X) X(0, "x2")
#define __FKCALL_ITER_IN_2(X)  __FKCALL_ITER_IN_1(X) X(1, "x3")
#define __FKCALL_ITER_IN_3(X)  __FKCALL_ITER_IN_2(X) X(2, "x4")
#define __FKCALL_ITER_IN_4(X)  __FKCALL_ITER_IN_3(X) X(3, "x5")
#define __FKCALL_ITER_IN_5(X)  __FKCALL_ITER_IN_4(X) X(4, "x6")
#define __FKCALL_ITER_IN_6(X)  __FKCALL_ITER_IN_5(X) X(5, "x7")
#define __FKCALL_ITER_IN_7(X)  __FKCALL_ITER_IN_6(X) X(6, "x8")
#define __FKCALL_ITER_IN_8(X)  __FKCALL_ITER_IN_7(X) X(7, "x9")
...
#define __FKCALL_ITER_OUT_1(X)  __FKCALL_ITER_OUT_0(X) X(0, "x1")
#define __FKCALL_ITER_OUT_2(X)  __FKCALL_ITER_OUT_1(X) X(1, "x2")
#define __FKCALL_ITER_OUT_3(X)  __FKCALL_ITER_OUT_2(X) X(2, "x3")
#define __FKCALL_ITER_OUT_4(X)  __FKCALL_ITER_OUT_3(X) X(3, "x4")
#define __FKCALL_ITER_OUT_5(X)  __FKCALL_ITER_OUT_4(X) X(4, "x5")
#define __FKCALL_ITER_OUT_6(X)  __FKCALL_ITER_OUT_5(X) X(5, "x6")
#define __FKCALL_ITER_OUT_7(X)  __FKCALL_ITER_OUT_6(X) X(6, "x7")
#define __FKCALL_ITER_OUT_8(X)  __FKCALL_ITER_OUT_7(X) X(7, "x8")
...
/*
 * `arch_pnc_fast_kernel_call_i18_o18` is implemented directly in assembly as it
 * would overflow gcc's hard limit in terms of number of operands allowed for
 * inline assembly.
 */
int arch_pnc_fast_kernel_call_i18_o18(int kcall, pnc_kcall_args_t *regs);

#endif /* _LIBPNC_ARCH_ARMV8_SYSCALL_LOW_H_INCLUDED_ */
