...
/**
 * @file    : platform.h
 * @brief   : All platform specific definitions
 *
 * @author  : Aymeric PLOTON aymeric.ploton@provenrun.com
 * @date    : 17/05/2024 (creation)
 * Copyright (c) 2023-2024 ProvenRun S.A.S and/or its affiliates.
 * All Rights Reserved.
 */
...
// Départ addresse de base + taille jusqu'à provencore
#define NS_DDR_BASE_PA          PADDR_C(0x81800000)		// The base address of the non secure memory
#define NS_DDR_SIZE             SIZE_C(0x7EA00000)		// The size of the non secure memory (end : 0x8_FFFF_FFFF)
...
/* Platform memory map */
#define VM_MAPPING_REGIONS      2				// 2 memory regions in the macro MEMORY_MAP will be mapped.
