...
static const struct mrc_t mrcs0[] = {
    [0] = {.start_pa = MRC_ADDR_REQ(0x80200000), .end_pa = MRC_ADDR_REQ(0x81800000)},	/* cf platform.h */
    /* [1] = {.start_pa = MRC_ADDR_REQ(0x880200000), .end_pa = MRC_ADDR_REQ(0x881800000)}, */	/* cf platform.h */
};
