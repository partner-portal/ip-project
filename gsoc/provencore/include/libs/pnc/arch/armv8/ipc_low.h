...
#ifndef _LIBPNC_ARCH_ARMV8_IPC_LOW_H_INCLUDED_
#define _LIBPNC_ARCH_ARMV8_IPC_LOW_H_INCLUDED_
                ...
                uint64_t timeout)
{
    ...
    register uint64_t x0  asm ("x0")  = ipc_type_u64;
    register uint64_t x1  asm ("x1")  = mptr_u64;
    register uint64_t x2  asm ("x2")  = target_u64;
    register uint64_t x3  asm ("x3")  = timeout;

    register int64_t x0_out asm ("x0");
...
#endif /* _LIBPNC_ARCH_ARMV8_IPC_LOW_H_INCLUDED_ */
