 ...
 *                      - 0 on success
 */
int pnc_session_send_response(struct pnc_session *session, uint32_t response);
 ...
 *                      - 0 on success
 */
int pnc_session_get_response(struct pnc_session *session, uint32_t *response);
 ...
 *                      - 0 on success
 */
int pnc_session_wait_response(struct pnc_session *session, uint32_t *response,
		uint32_t timeout);
 ...
 *                      - 0 on success
 */
int pnc_session_send_request(struct pnc_session *session, uint32_t request);
 ...
 *                      - 0 on success
 */
int pnc_session_get_request(struct pnc_session *session, uint32_t *request);
 ...
 *                      - 0 on success
 */
int pnc_session_wait_request(struct pnc_session *session, uint32_t *request,
				uint32_t timeout);
 ...
 */
int pnc_session_cancel_request(struct pnc_session *session, uint32_t *response,
			       uint32_t timeout);
 ...
 *                      - -EINVAL if invalid session handle
 *                      - -ENODEV if session not configured
 *                      - -EPROTO if \p bits bitfield is empty.
 *                      - 0 on success
 */
int pnc_session_send_signal(struct pnc_session *session, uint32_t bits);
 ...
 *                      - 0 on success
 */
int pnc_session_get_signal(struct pnc_session *session, uint32_t *signals);
 ...
 *                      - 0 on success
 */
int pnc_session_wait_signal(struct pnc_session *session, uint32_t *signals,
				uint32_t timeout);
 ...
 *                      - 0 on success
 */
int pnc_session_wait_event(struct pnc_session *session, uint32_t *events,
